...
export default function DashboardBlogCreate() {
  ...
  async function handleSubmit(isActive: boolean) {
    ...
    if (imageMode === "upload" && !imageFile) {
      setError("Please upload a cover image or switch to URL mode.");
      return;
    }

    if (imageMode === "url" && !imageUrl.trim()) {
      setError("Please enter a cover image URL or switch to upload mode.");
      return;
    }
        ...
        <div className="space-y-3">
          ...
          <div className="space-y-2">
            ...
            <p className="max-w-3xl text-sm leading-relaxed text-[#0A211F]/68 sm:text-base">
              Fill in the blog details, upload a cover image, write your content, and optionally add SEO fields before publishing.
            </p>
          </div>
        </div>
