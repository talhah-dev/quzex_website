...
import type { CreateServicePayload, ServicePricingPlan } from "@/types";
...
export default function DashboardServiceCreate() {
  ...
  const [title, setTitle] = useState("New service preview title");
  const [category, setCategory] = useState("");
  const [priority, setPriority] = useState("1");
  const [duration, setDuration] = useState("");
  const [description, setDescription] = useState(
    "A short service description will appear here while you prepare the new entry."
  );
        ...
        <div className="flex flex-col gap-6">
            ...
            <div className="space-y-3">
              ...
              <div className="space-y-2">
                ...
                <p className="max-w-3xl text-sm leading-relaxed text-[#0A211F]/68 sm:text-base">
                  Prepare a service entry with listing details, service highlights, and pricing
          ...
          <div className="grid gap-5 md:grid-cols-2">
            <div className="grid gap-2">
              ...
              <Input
                id="service-title"
                placeholder="Dynamic Website Development"
                value={title}
            ...
            <div className="grid gap-2 md:col-span-2">
              ...
              <textarea
                ...
                rows={4}
                placeholder="Write the listing description for this service."
                value={description}
            ...
            <div className="grid gap-2 md:col-span-2">
              ...
              <textarea
                ...
                rows={4}
                placeholder="Add service highlights, one per line."
                value={highlights}
            ...
            {imageMode === "upload" ? (
              ...
              >
                ...
                <div className="space-y-1">
                  ...
                  <p className="text-xs text-[#0A211F]/58">
                    Add a cover image that will be used on the services page and detail page.
                  </p>
                  {imageFile ? (
