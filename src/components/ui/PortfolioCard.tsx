        ...
        <Card className="rounded-2xl border-none bg-transparent p-0 shadow-none">
            <CardContent className="flex flex-col gap-6 p-0">
                ...
                <div className="flex flex-col gap-3 pb-6">
                    <div
                        className={`inline-flex w-fit items-center gap-2 transition-colors ${isClickable
                                ? "text-[#D8F782] group-hover:text-white"
                                : "text-[#E9F3E6]/72"
                            }`}
                    >
                    ...
                    <p
                        className={`w-fit text-xl font-medium sm:text-2xl ${isClickable
                                ? "text-[#E9F3E6] transition-colors group-hover:text-[#D8F782]"
                                : "text-[#E9F3E6]"
                            }`}
                    >
                        {item.title}
